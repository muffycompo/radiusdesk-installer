...
if [[ ! -f "${TEMP_PATH}download_complete.txt" ]]; then
	...
	wget_download https://github.com/cakephp/cakephp/archive/master.zip ${TEMP_PATH}cakephp.zip
	...
	# 2.2 download	
	#wget_download ftp://ftp.freeradius.org/pub/freeradius/freeradius-server-2.2.8.tar.gz ${TEMP_PATH}freeradius-server-2.2.8.tar.gz
	wget_download ftp://ftp.freeradius.org/pub/freeradius/freeradius-server-3.0.9.tar.gz ${TEMP_PATH}freeradius-server-3.0.9.tar.gz
...
if [[ "${webserver}" = "nginx" ]]; then
	...
	echo ""
	echo "============================================================="
	echo -e "9. Starting ${LIGHT_BLUE}${BOLD}services${F_END} needed by RADIUSdesk"
...
echo ""
echo "============================================================="
echo -e "10. Installing ${LIGHT_BLUE}${BOLD}CakePHP${F_END}"
install_cakephp ${TEMP_PATH} ${HTTP_DOCUMENT_ROOT}

# Install rd_cake, rd2, meshdesk, rd_clients, rd_login_pages
echo ""
echo "============================================================="
echo -e "11. Installing ${LIGHT_BLUE}${BOLD}RADIUSdesk${F_END}"
install_radiusdesk ${TEMP_PATH} ${SOURCE_DIR} ${HTTP_DOCUMENT_ROOT}

echo ""
echo "============================================================="
echo -e "12. Installing ${LIGHT_BLUE}${BOLD}Sencha ExtJS${F_END}"
install_extjs ${TEMP_PATH} ${HTTP_DOCUMENT_ROOT}

# RADIUSdesk cron script
echo ""
echo "============================================================="
echo -e "13. Installing ${LIGHT_BLUE}${BOLD}Cron Script${F_END} for RADIUSdesk"
...
echo
echo "============================================================="
echo -e "15. Installing ${LIGHT_BLUE}${BOLD}FreeRADIUS${F_END}"
